...
This is a part of cuda sdr project, written in pure c++ without any other dependencies, which can be easily changed to cuda implementation. 
...
***Notes: since we only tested this code using a limit bunch of input, there might be unforeseen bugs in some cases.***
