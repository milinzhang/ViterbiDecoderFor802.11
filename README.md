...
Another thing to which readers should pay attention is that the decoder should always start from the all zero state. Our way to do this is to give a initial score to state 0 which can ensure that other branchs not start from state 0 can be pruned.
